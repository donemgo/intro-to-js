...
// || OR . the "or" statement simply looks at two values and checks to see if one of them is true, if one is true it is satisfied

const me = true;
const you = false;

me || you || console.log('I passed o');
// && AND . the "and" statement, unlike the OR is kind of stricter, it wants and needs all values to be true before it can allow you through. these operators return boolean values at the end
const me = true;
const you = true;
